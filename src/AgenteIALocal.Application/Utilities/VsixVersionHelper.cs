// MOVIDO - ID: 20260128_020300 - De AgenteIALocalVSIX.Commons a AgenteIALocal.Application.Utilities
// Para evitar duplicación de código y permitir reutilización en AboutInfoService
using System;
using System.IO;
using System.Linq;
...
namespace AgenteIALocal.Application.Utilities
{
    /// <summary>
    /// Extension methods para obtener versión de VSIX
    /// MOVIDO - ID: 20260128_020300 - De VSIX a Application para reutilización
    /// </summary>
    public static class VsixVersionHelper
    {
        /// <summary>
        ...
        public static string GetVsixVersionString(this Assembly assembly, string fallback = "desconocida")
        {
            ...
            // 2) Fallback: versiones del assembly
